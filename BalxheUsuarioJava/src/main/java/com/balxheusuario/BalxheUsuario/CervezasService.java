...
public class CervezasService {
	...
	public CervezasService() {
		...
		lista.add(new Cervezas ("Modelo Especial 355ml", "Cerveza color dorado brillante, un sabor dulce y bien equilibrado con lúpulos ligeros y un final fresco.",30, 22, "Modelo-especial.png"));
		lista.add(new Cervezas ("Modelo Negra 355ml", "Cerveza oscura con sabor intenso y equilibrado, aroma a caramelo y malta tostada y un sabor con un final poco intenso por su selección de lúpulo.",210, 22, "modelo-negra.png"));
		lista.add(new Cervezas ("Victoria 355ml", "Esta cerveza ofrece un agradable aroma a maltas y lúpulo de la más alta calidad, color ámbar y consistente espuma.",10, 21, "victoria.png"));
		lista.add(new Cervezas ("Tecate Light 355ml", "Tecate Light es una cerveza tipo light lager, con un sabor ligero, balanceado y suave que ofrece al consumidor un sabor único gracias a sus ingredientes de óptima calidad. 3.9% Alc. Vol. Historia: En 1992, Tecate lanza Tecate Light, la primera cerveza Light en México.",110, 20, "Tecate-light.png"));
		lista.add(new Cervezas ("Bohemia 355ml", "Bohemia es una cerveza mexicana producida por la cervecería Cuauhtémoc Moctezuma. Se trata de una cerveza de tipo Pilsner, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo pronunciado. Se caracteriza por su sabor suave y refrescante, así como por su color dorado claro y su espuma blanca y consistente.", 200, 20, "bohemia.png"));
		lista.add(new Cervezas ("Heineken 355ml", "Heineken es una cerveza holandesa producida por la cervecería Heineken International. Es una cerveza de tipo Pilsner, es decir, una cerveza de malta clara con un perfil de sabor a lúpulo pronunciado. Se caracteriza por su sabor suave y refrescante, así como por su color dorado claro y su espuma blanca y consistente.", 57, 23, "heineken.png"));
		lista.add(new Cervezas ("Cerveza Indio 355ml", "INDIO es una cerveza obscura estilo Lager Vienna que se caracteriza por su sabor único y especial. Esta cerveza fue creada a partir de la fusión de dos ingredientes clave: la malta dorada y el caramelo tostado. Esta combinación le da a INDIO leves tonos de dulzor y reduce los niveles de amargor, lo que la hace muy agradable y fácil de beber.",80, 15, "indio.png"));
