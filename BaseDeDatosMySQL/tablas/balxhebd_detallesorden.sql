...
CREATE TABLE `detallesorden` (
  ...
  UNIQUE KEY `idDetallesOrden_UNIQUE` (`idDetallesOrden`),
  KEY `fk_detallesOrden_productos1_idx` (`FK_idProducto`),
  KEY `fk_detallesOrden_ordenes1_idx` (`FK_idOrdenes`),
  CONSTRAINT `fk_detallesOrden_ordenes1` FOREIGN KEY (`FK_idOrdenes`) REFERENCES `ordenes` (`idOrdenes`),
  CONSTRAINT `fk_detallesOrden_productos1` FOREIGN KEY (`FK_idProducto`) REFERENCES `productos` (`idProducto`)
